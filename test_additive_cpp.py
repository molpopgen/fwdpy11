...
def evolve_and_return(args):
    ...
    recregions=nregions
    fitness=fwdpy11.SpopAdditive(2.0)
    fwdpy11.wright_fisher.evolve_regions_sampler_fitness(rng,pop,rec,fitness.callback,N,1000,0.001,0.005,0.001,nregions,sregions,recregions)
