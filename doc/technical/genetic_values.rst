...
is necessary (see :ref:`here <snowdrift_cpp_example>` for a C++ implementation
...
.. _snowdrift_cpp_example:

Example: a snowdrift model
++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

This example is based on [Doebeli2004]_ and comes from the ``fwdpy11`` test suite.
