...
An edge table contains all the data required to generate what we may call "marginal trees", which are the trees
...
msprime package to illustrate the concepts.  fwdpy11 uses the same basic data model, and it is more convenient to use trees
