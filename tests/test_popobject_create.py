...
class testDiploidPopulationCreate(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.haploid_genomes.append(fwdpy11.HaploidGenome((2, [], [0])))
...
class testHaploidGenomeKeySorting(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.haploid_genomes.append(fwdpy11.HaploidGenome((1, [], [0])))
        self.haploid_genomes.append(fwdpy11.HaploidGenome((1, [], [0, 1])))
