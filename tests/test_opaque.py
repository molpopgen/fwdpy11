...
class testSlocusPop(unittest.TestCase):
    ...
    def test_mutations(self):
        self.assertTrue(type(self.pop.mutations) is fwdpy11.fwdpy11_types.MutationContainer)
        self.assertFalse(type(self.pop.mutations) is list)
        self.assertTrue(type(list(self.pop.mutations)) is list)
    def test_mcount(self):
        self.assertTrue(type(self.pop.mcounts) is fwdpy11.fwdpy11_types.VectorUint32)
    def test_diploids(self):
        self.assertTrue(type(self.pop.diploids) is fwdpy11.fwdpy11_types.DiploidContainer)
    def test_a_diploid(self):
        self.assertTrue(type(self.pop.diploids[0]) is fwdpy11.fwdpy11_types.SingleLocusDiploid)
    def test_gametes(self):
        self.assertTrue(type(self.pop.gametes) is fwdpy11.fwdpy11_types.GameteContainer)
...
class SlocusTypeSampler(object):
    def __call__(self,pop):
        ...
        assert(type(pop.diploids[0]) is fwdpy11.fwdpy11_types.SingleLocusDiploid)
...
class testMlocusPop(unittest.TestCase):
    ...
    def test_diploids(self):
        ...
        self.assertTrue(type(self.pop.diploids) is fwdpy11.fwdpy11_types.VecDiploidContainer)
    def test_a_diploid(self):
        self.assertTrue(type(self.pop.diploids[0]) is fwdpy11.fwdpy11_types.DiploidContainer)
    def test_gametes(self):
        self.assertTrue(type(self.pop.gametes) is fwdpy11.fwdpy11_types.GameteContainer)
