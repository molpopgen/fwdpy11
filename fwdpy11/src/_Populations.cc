    ...
    py::class_<fwdpy11::SlocusPop, fwdpy11::Population>(
        ...
        .def(py::pickle(
            ...
            [](py::object pickled) -> fwdpy11::SlocusPop {
                ...
                std::istringstream in(s.cast<std::string>());
                fwdpy11::SlocusPop rv(1, std::numeric_limits<double>::max());
                fwdpy11::serialization::deserialize_details()(in, rv);
                return rv;
            }))
        .def("sample",
